...
for i in range(1):
    ...
    B = np.array([[B_L_lv_line_1km + B_L_lv_line_two_inverters, -B_L_lv_line_1km, -B_L_lv_line_two_inverters],
                  [-B_L_lv_line_1km,B_L_lv_line_1km, 0],
                  [-B_L_lv_line_two_inverters, 0, B_L_lv_line_two_inverters]])
...
for i in range(1):
    ...
    B = np.array([[B_L_lv_line_1km + B_L_lv_line_two_inverters, -B_L_lv_line_1km, -B_L_lv_line_two_inverters],
                  [-B_L_lv_line_1km,B_L_lv_line_1km, 0],
                  [-B_L_lv_line_two_inverter, 0, B_L_lv_line_two_inverters]])
