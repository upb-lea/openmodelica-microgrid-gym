...
net = Network.load('microgrid_check.yaml')
...
if __name__ == '__main__':
    ...
    env = gym.make('openmodelica_microgrid_gym:ModelicaEnv_test-v1',
                   ...
                   model_params={'rl1.resistor1.R': partial(load_step, gain=20 / 1.4),
                                 'rl1.resistor2.R': partial(load_step, gain=20 / 1.4),
                                 'rl1.resistor3.R': partial(load_step, gain=20 / 1.4),
                                 'rl1.inductor1.L': partial(load_step, gain=0.031 / 1.4),
                                 'rl1.inductor2.L': partial(load_step, gain=0.031 / 1.4),
                               'rl1.inductor3.L': partial(load_step, gain=0.031 / 1.4)
                                 },
