...
step_l[0:500] = 0.421 # in Henry
step_l[500:]  = 0.210  # in Henry
...
plt.plot(m.time,w1, 'r', label='f1')
plt.plot(m.time,w2, 'b', label='f2')
plt.plot(m.time,w3,'--g', label='f3')
plt.xlabel('Time (s)')
...
plt.plot(m.time,P3,'r', label='P3')
plt.plot(m.time,Q3,'b', label='Q3')
#plt.plot(m.time,Q3,'g')
plt.xlabel('Time (s)')
plt.ylabel('Bus 3 Power')
#plt.ylim(-100, 100)
plt.show()
