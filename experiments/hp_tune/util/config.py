cfg = dict(lea_vpn_nodes=['lea-skynet', 'lea-picard', 'lea-barclay',
           ...
           STUDY_NAME='OMG_DDPG_Integrator_no_pastVals_i_load_feature_corr',
           meas_data_folder='Json_to_MonogDB_OMG_DDPG_Integrator_no_pastVals_i_load_feature_corr_New/',
           MONGODB_PORT=12001,
           loglevel='test',
           is_dq0=True,
