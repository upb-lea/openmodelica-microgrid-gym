cfg = dict(lea_vpn_nodes=['lea-skynet', 'lea-picard', 'lea-barclay',
           ...
           STUDY_NAME='PC2_DDPG_Vctrl_single_inv_HPO_noI_term_study_25_withoutSinCos',
           # STUDY_NAME='PC2_DDPG_Vctrl_single_inv_PastValHPO_without_phaseFeature',
           meas_data_folder='Json_to_MonogDB_study_25/',
           MONGODB_PORT=12001,
           loglevel='test',
           is_dq0=True,
...
# Future_10Rvals_study_withNormalization
