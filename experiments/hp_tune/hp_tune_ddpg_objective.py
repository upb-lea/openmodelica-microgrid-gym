...
def ddpg_objective(trial):
    ...
    learning_rate = 1.5e-6  # trial.suggest_loguniform("learning_rate", 1e-8, 5e-2)  # 0.0002#

    lr_decay_start = 0.6  # trial.suggest_float("lr_decay_start", 0.00001, 1)  # 3000  # 0.2 * number_learning_steps?
    lr_decay_duration = 0.9  # trial.suggest_float("lr_decay_duration", 0.00001,
    ...
    final_lr = 0.35  # trial.suggest_float("final_lr", 0.00001, 1)
    ...
    use_gamma_in_rew = 1
    noise_var = 0.2  #trial.suggest_loguniform("noise_var", 0.01, 4)  # 2
    ...
    # number_learning_steps)
    noise_theta = 26  # trial.suggest_loguniform("noise_theta", 1, 50)  # 25  # stiffness of OU
