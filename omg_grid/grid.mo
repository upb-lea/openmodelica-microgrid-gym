...
<li><em> 1998   </em>
  ...
  model microgrid
    ...
    Modelica.Blocks.Interfaces.RealInput i1p3 annotation(
      Placement(visible = true, transformation(origin = {-104, 42}, extent = {{-8, -8}, {8, 8}}, rotation = 0), iconTransformation(origin = {-104, 42}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  grid.loads.rl rl1(L1 = 0.424, L2 = 0.424, L3 = 0.424, R1 = 5.29, R2 = 5.29, R3 = 5.29)  annotation(
      Placement(visible = true, transformation(origin = {92, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  grid.ideal_filter.l l12(L1 = 0.05, L2 = 0.05, L3 = 0.05)  annotation(
      Placement(visible = true, transformation(origin = {2, 0}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  grid.ideal_filter.l l13(L1 = 0.05, L2 = 0.05, L3 = 0.05)  annotation(
      Placement(visible = true, transformation(origin = {46, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  grid.ideal_filter.l l23(L1 = 0.05, L2 = 0.05, L3 = 0.05)  annotation(
  ...
  connect(inverter2.pin1, lc2.pin1) annotation(
      Line(points = {{-60, -36}, {-40, -36}}, color = {0, 0, 255}));
  connect(lc2.pin6, l12.pin6) annotation(
      Line(points = {{-20, -24}, {8, -24}, {8, -10}}, color = {0, 0, 255}));
  connect(lc2.pin5, l12.pin5) annotation(
      Line(points = {{-20, -30}, {2, -30}, {2, -10}}, color = {0, 0, 255}));
  connect(lc2.pin4, l12.pin4) annotation(
      Line(points = {{-20, -36}, {-4, -36}, {-4, -10}}, color = {0, 0, 255}));
  connect(lc2.pin6, l23.pin3) annotation(
      Line(points = {{-20, -24}, {38, -24}}, color = {0, 0, 255}));
  connect(lc2.pin5, l23.pin2) annotation(
      Line(points = {{-20, -30}, {38, -30}}, color = {0, 0, 255}));
  connect(lc2.pin4, l23.pin1) annotation(
      Line(points = {{-20, -36}, {38, -36}}, color = {0, 0, 255}));
    annotation(
      Diagram);
  end microgrid;
