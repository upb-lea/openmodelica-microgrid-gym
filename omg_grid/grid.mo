...
<li><em> 1998   </em>
  ...
  package plls
    model pll
      ...
      Modelica.Blocks.Continuous.PI pi(T = 0.05, k = 10) annotation(
    ...
    annotation(
        Diagram(graphics = {Text(origin = {25, 23}, extent = {{-1, -1}, {1, 1}}, textString = "text")}));end pll;
  end plls;
